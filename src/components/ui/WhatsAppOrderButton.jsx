...
export default function WhatsAppOrderButton({ 
  ...
  return (
    <a 
      ...
      target="_blank"
      rel="noreferrer"
      // Note the rounded-none class here to keep it perfectly square
      className="flex items-center justify-center gap-3 w-full bg-white text-black font-semibold text-sm uppercase tracking-widest py-4 rounded-none hover:bg-[#E88C15] hover:text-white transition-all duration-300 mb-4"
    >
      {/* WhatsApp Icon */}
